...
function Banner() {
  return (
    ...
    <div className=' w-1/2'>
     <p className=' text-7xl font-semibold  text-customColorC   float-left mt-24 ml-10  '>Learn Without </p>
      <p className='font-semibold text-7xl  text-customColorC ml-11 mt-4 float-left '>limits </p>
...
//   return (
//     <Carousel className="  h-96 overflow-y-hidden">
