...
export default function Courseattend() {
    ...
    async function getCourse() {
        ...
        const progress_response = await instance.get(`learning/progress/${course_id.id}/${user_name.user_id}`)

        const getprogress = await instance.get(`learning/getprogress/${course_id.id}/${user_name.user_id}`)
